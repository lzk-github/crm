    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="box">
                ...
                <div class="box-body">
                    <form action="/task/edit/post" method="post" id="editTaskForm">
                        ...
                        <div class="form-group">
                            <label>完成日期</label>
                            <input type="text" class="form-control" id="datepicker" name="endTime" value="${task.endTime}">
                        </div>
                        <div class="form-group">
                            <label>提醒时间</label>
                            <input type="text" class="form-control" id="datepicker2" name="remindTime" value="${task.remindTime}">
                        </div>
                    </form>
                </div>
                <!-- /.box-body -->
                <div class="box-footer">
                    <button id="editTaskBtn" class="btn btn-primary">保存</button>
                </div>
            </div>
            <!-- /.box -->
