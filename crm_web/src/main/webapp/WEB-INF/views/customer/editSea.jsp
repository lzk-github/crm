        ...
        <section class="content">
            ...
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">编辑公海客户</h3>
                    <div class="box-tools pull-right">
                        <a href="/customer/sea/${customer.id}" class="btn btn-primary btn-sm"><i class="fa fa-arrow-left"></i> 返回客户详情</a>
                    </div>
                </div>
                <div class="box-body">
